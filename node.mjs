...
;
	($.$mvc_app) = class $mvc_app extends ($.$mol_page) {
		Login(){
		...
		Unit_name(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.unit_name(id)));
			return obj;
		}
		Unit_name_change(id){
			const obj = new this.$.$mol_string();
			(obj.value) = (next) => ((this.unit_name(id, next)));
			return obj;
		}
		Unit_remove(id){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ("Удалить юнита");
			return obj;
		}
		Unit_copy(id){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ("Копироваь юнита");
			return obj;
		}
		skill_name(id, next){
			if(next !== undefined) return next;
		...
		Skill_name(id){
			const obj = new this.$.$mol_string();
			(obj.value) = (next) => ((this.skill_name(id, next)));
			return obj;
		}
		Skill_remove(id){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ("Удалить скилл");
			return obj;
		}
		Skill_add(id){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ("Добавить умение");
			return obj;
		}
		Skill(id){
		...
		Units(){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ((this.units_list()));
			return obj;
		}
		Unit_add(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ("Добавить юнита");
			return obj;
		}
		Auth(){
		...
		body(){
			return [(this.Login()), (this.Auth())];
		}
	};
	($mol_mem(($.$mvc_app.prototype), "Login"));
	($mol_mem(($.$mvc_app.prototype), "user_name"));
	($mol_mem(($.$mvc_app.prototype), "User_name"));
	($mol_mem(($.$mvc_app.prototype), "User_logout"));
	($mol_mem(($.$mvc_app.prototype), "Unit_length"));
	($mol_mem_key(($.$mvc_app.prototype), "Unit_id"));
	($mol_mem_key(($.$mvc_app.prototype), "unit_name"));
	($mol_mem_key(($.$mvc_app.prototype), "Unit_name"));
	($mol_mem_key(($.$mvc_app.prototype), "Unit_name_change"));
	($mol_mem_key(($.$mvc_app.prototype), "Unit_remove"));
	($mol_mem_key(($.$mvc_app.prototype), "Unit_copy"));
	($mol_mem_key(($.$mvc_app.prototype), "skill_name"));
	($mol_mem_key(($.$mvc_app.prototype), "Skill_name"));
	($mol_mem_key(($.$mvc_app.prototype), "Skill_remove"));
	($mol_mem_key(($.$mvc_app.prototype), "Skill_add"));
	($mol_mem_key(($.$mvc_app.prototype), "Skill"));
	($mol_mem_key(($.$mvc_app.prototype), "Skills"));
	($mol_mem_key(($.$mvc_app.prototype), "Unit"));
	($mol_mem(($.$mvc_app.prototype), "Units"));
	($mol_mem(($.$mvc_app.prototype), "Unit_add"));
	($mol_mem(($.$mvc_app.prototype), "Auth"));
	($mol_mem(($.$mvc_app.prototype), "user"));
